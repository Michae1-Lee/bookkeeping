...
@Configuration
@ComponentScan("com.spring.libraryproject")
@EnableWebMvc
@EnableTransactionManagement
    @EnableJpaRepositories("com.spring.libraryproject.repositories")
...
private Properties hibernateProperties() {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.spring.libraryproject.models");
